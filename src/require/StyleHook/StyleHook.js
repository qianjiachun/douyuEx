/*
    ...
    By 小淳
*/
export function StyleHook_set(styleName, styleText) {
...
export function StyleHook_remove(styleName) {
...
export function StyleHook_setIframe(dom, styleName, styleText) {
    // styleName：样式id名，建议以Ex_Style_大驼峰的形式命名
...
export function StyleHook_removeIframe(dom, styleName) {
